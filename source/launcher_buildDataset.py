...
import launcher_audioNormalization  
...
#             print(ind_dt , '/',len(timestamp_csv))
    ...
    if (ct_anormal_duration>0) | (ct_anormal_size>0):
        ...
        os.system('chmod -R g+rwx /home/datawork-osmose/dataset/'+dataset_ID)
        print('\n DONE ! your dataset is on OSmOSE platform !')
        
        launcher_audioNormalization.main( dataset_ID , df['orig_fs'] , df['orig_fileDuration'][0] )
        print('\n and we are now launching preliminary analysis of your dataset !')
